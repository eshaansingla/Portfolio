document.getElementById("nav-buttonspc").addEventListener("click", function() {
      document.documentElement.classList.toggle('dark-mode');
      if(document.documentElement.classList.contains('dark-mode')){
        document.getElementById("nav-buttonspc").innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
        ...
        document.getElementById("nav-buttonspc").innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
...
/* <nav class="navbar navbar-expand-lg navbar-dark" id="navbar">
        <div class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
            <img src="E.png" height="45" width="45" class="icon"></div>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item" id="nav-items">
                    <a href="#" class="nav-link text-white d-flex flex-column align-items-center" id="nav-button">
